...
RESULTS_PATH: str = f"{RESULTS_DIR}/results_{_get_current_file_number(RESULTS_DIR) + 1}.csv"
...
# runtime config
NUM_WORKERS: int = max(2, os.cpu_count() // 2) # change to whatever is best for you
IS_RESUME:  bool = False
APPEND_LOG: bool = False



def load_config(num_workers: int = None, is_resume: bool = None, append_log: bool = None) -> None:
